<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto">
            @if ($errors->any())
                <div class="p-4 mb-4 text-sm text-white rounded-lg bg-red-600 dark:bg-gray-800"
                    role="alert">
                    <ul>
            ...
            <div class="relative overflow-x-auto border border-1 border-gray-200 rounded p-4 bg-white mb-4">
                <form action="{{ route('tickets.update', $ticket) }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="name" name="title" value="{{ old('title', $ticket->title) }}"
                            ...
                            @foreach ($categories as $item)
                                <div>
                                    <input id="{{ $item->id }}" type="checkbox" value="{{ $item->id }}"
                                        name="categories[]" @checked($item->checked)
